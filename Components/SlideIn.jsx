    ...
    <AnimatePresence>
      ...
      >
        <div className='p-2 md:max-w-3xl '>
          <button
            className='absolute top-2 right-2 text-gray-700 hover:bg-teal-400 hover:text-gray-900  transition duration-100 ease-in'
            onClick={onClose}
          >
            X
          </button>
        ...
        <button className='bg-teal-200'>Superb! 🥇🥇</button>
      </motion.div>
    </AnimatePresence>
  );
}
