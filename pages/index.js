              ...
              {!balance || balance < 100 ? (
                ...
                <InsightsCard text='Historical Analysis'>
                  <div className='flex w-[80vw] h-full justify-center items-center'>
                    <Charts height={mobile ? 400 : 280} chartData={chartData} />
                  </div>
                </InsightsCard>
              )}
            </div>
            ...
            <footer className='footer-distributed'>
              ...
              <div className='footer-right'>
                <p className='footer-company-about'>
                  ...
                  The website&apos;s information isn&apos;t investment,
                  financial, or trading advice. Don&apos;t interpret its content
                  as such. Do your research and seek professional advice for
                  financial decisions.
                </p>
